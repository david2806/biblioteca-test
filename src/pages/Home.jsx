...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="relative bg-gradient-hero py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 text-primary-900">
              Descubre Tu Próxima
            ...
            <p className="text-xl md:text-2xl text-primary-800 mb-8 max-w-2xl mx-auto font-light">
            ...
            <motion.div 
              ...
              className="flex justify-center gap-8 mb-10 text-primary-700"
            >
          ...
          >
            ...
            <Card className="p-0 overflow-hidden shadow-elegant-lg hover:shadow-elegant-dark-lg">
              <div className="grid md:grid-cols-5 gap-0">
                ...
                <div className="md:col-span-3 p-8 md:p-12 flex flex-col justify-center bg-gradient-to-br from-white to-warm-50">
                  <div className="inline-block mb-3">
                    <span className="px-4 py-1.5 bg-gradient-primary text-white text-sm font-semibold rounded-full">
                      {bookOfTheDay.volumeInfo?.categories?.[0] || 'Destacado'}
                    </span>
                  </div>
                  <h3 className="text-3xl md:text-4xl font-serif font-bold mb-3 text-primary-800">
      ...
      {/* Popular Books */}
      <section className="py-16 bg-gradient-to-br from-warm-50 to-white">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <Card className="text-center p-12 md:p-16 relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary-50 to-warm-50 opacity-50"></div>
              ...
              <div className="relative z-10">
                <motion.div
                  ...
                  className="inline-block mb-6"
                >
                  <Heart className="w-16 h-16 text-accent-coral" />
                </motion.div>
                
                <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-primary-800">
                  ¿Listo para Comenzar tu Viaje de Lectura?
                </h2>
                <p className="text-xl text-warm-700 mb-10 max-w-3xl mx-auto leading-relaxed">
